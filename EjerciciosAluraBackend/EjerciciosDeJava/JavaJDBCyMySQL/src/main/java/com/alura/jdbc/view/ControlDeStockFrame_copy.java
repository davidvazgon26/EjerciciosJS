 ...
 * 
 * public class ControlDeStockFrame_copy extends JFrame {
 * 
 ...
 * return tabla.getSelectedRowCount() == 0 || tabla.getSelectedColumnCount() ==
 * 0;
 * }
 * 
 ...
 * Integer id = Integer.valueOf(modelo.getValueAt(tabla.getSelectedRow(),
 * 0).toString());
 * 
 * Integer cantidad = Integer.valueOf(modelo.getValueAt(tabla.getSelectedRow(),
 * 3).toString());
 * 
 ...
 * 
 * JOptionPane.showMessageDialog(this, cantidadEliminada + " Item(s)
 * eliminado(s) con éxito!");
 * }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
 * }
 * 
 ...
 * {
 * JOptionPane.showMessageDialog(this, "Los campos Nombre y Descripción son
 * requeridos.");
 * return;
 * }
 * 
 ...
 * .format("El campo cantidad debe ser numérico dentro del rango %d y %d.", 0,
 * Integer.MAX_VALUE));
 * return;
 * }
 * 
