...
*/
    ...
    public static void main(String[] args) {
        ...
        // Buscar un alumno
        System.out.println(alumno1.equals(alumnoNuevo)); // false, porque aunque las propiedades son iguales no es el mismo espacio de memoria, para que funcione hay que sobreescribir el metodo en la clase Alumno.
