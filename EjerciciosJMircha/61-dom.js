...
// const David = {
//   LenguajesDeProgramación: ["JavaScript", "SQL"],
//   MaquetadoYEstilos: ["HTML", "CSS"],
//   Frameworks_Librerías_entorno_de_desarrollo: ["Node.js", "React", "Redux"],
//   BasesDatos: ["MySQL", "PostgreSQL", "SQL Server"],
//   EntornoGrafico: ["PgAdmin", "Workbench", "MSSM"],
//   ControlVersiones: "Git",
//   ToolControlVersiones: ["Github", "Gitlab"],
//   InterfazGraficaGit: "SourceTree",
//   HerramientasMaquetado_y_diseño: "Figma",
// };
...
function flujoEventos(e) {
  console.log(
    `Hola te saluda ${this.className || this}, el click que origino fue ${
      e.target.className
    }`
  );
  e.stopPropagation();
