...
export default function getGeolocation(id) {
  const $id = d.getElementById(id),
    options = {
      enableHighAccuracy: true, //Mejor lectura posible
      timeout: 5000,
      maximumAge: 0, //nose guarde en cache la lectura
    };

  //investigar watchposition para seguir en movimiento.  watchPosition()
